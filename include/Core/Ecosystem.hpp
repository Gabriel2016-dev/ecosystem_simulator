...
// DESTRUCTEUR
Ecosystem::~Ecosystem() {
 std::cout << "🌍 Écosystème détruit (" << mEntities.size() << " entités nettoyé avec succes";
}
// ⚙️ INITIALISATION
void Ecosystem::Initialize(int initialHerbivores, int initialCarnivores, int initialisation){}
 mEntities.clear();
 mFoodSources.clear();
...
6.0f,
 ...
 SDL_SetRenderDrawColor(renderer, food.color.r, food.color.g, food.color.b, food.
